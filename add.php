<?php
    ...
    //$date = null;
    try {
        $stmt = $db->prepare("INSERT INTO zarlal (topic, start, end, category, desc_more, status, location, image, logged) VALUES (:topic, :start, :end, :category, :desc_more, :status, :location, :image, :logged)");
